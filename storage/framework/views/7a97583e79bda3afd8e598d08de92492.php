    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3 ms-auto">
            <div class="d-flex justify-content-end">
                ...
                <a href="<?php echo e(route('logs.checksum.all')); ?>" class="btn btn-primary ms-2">
                    <i class="fas fa-download me-1"></i> Download file checksum
                </a>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-info ms-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="align-middle">
                                <i class="fas fa-file-alt me-2"></i> <?php echo e($file['name']); ?>

                            </td>
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                                    <?php echo e(substr($file['sha256'], 0, 32)); ?>...
                                    <button class="btn btn-sm ms-2 copy-btn" data-clipboard-text="<?php echo e($file['sha256']); ?>" title="Copy to clipboard">
                                        <i class="fas fa-copy"></i>
                                    </button>
                                </div>
                            </td>
                            <td class="align-middle"><?php echo e($file['size']); ?></td>
                            <td class="align-middle">
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e($file['download_url']); ?>" class="btn btn-success">
                                        <i class="fas fa-download"></i>
                                    </a>
                                    <button class="btn btn-primary rounded-circle preview-btn" data-path="<?php echo e(storage_path('logs/' . $file['name'])); ?>">
